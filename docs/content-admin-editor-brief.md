...
`newsletter_archive`, `projects`, and `writing` page rows. The next safe step
is to keep migrating high-value public copy into reviewed content records
without adding an untracked save path.
