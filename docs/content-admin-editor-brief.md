...
| making index          | D1 `page_content:making`, seeded by `drizzle/migrations/0023_seed_making_index_page_content.sql` and `0035_seed_making_bucket_copy.sql`, fallback `@anipotts/content/public` defaults, rendered in `apps/www/src/pages/making.astro`                                                                                                                                                                                                                              | page title, meta description, hero title, hero summary, project bucket labels and notes                                                                                  | stable project-listing copy and bucket labels now have a structured source before any write path exists                                                                                    |
...
| project cards         | `content/public/projects/*.md`                                                                                                                                                                                                                                                                                                                                                                                                                                    | title, subtitle, description, year, category, role, duration, status, featured, visible, sort order, links, tags                                                         | source is already markdown-backed and editor-ready                                                                                                                                         |
...
| writing previews      | `content/public/writing/*.md`                                                                                                                                                                                                                                                                                                                                                                                                                                     | title, slug, summary, tags, status, published date, body                                                                                                                 | five published posts, mostly claude code and ai workflow                                                                                                                                   |
...
| p0       | keep making index copy and buckets D1-visible in admin  | route-level project-listing labels should be content state before write paths            | admin editor                  |
