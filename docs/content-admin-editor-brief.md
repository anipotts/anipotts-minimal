...
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| homepage hero         | D1 `page_content:home`, seeded by `drizzle/migrations/0010_seed_home_page_content.sql`, `0013_seed_homepage_proof_cards.sql`, `0014_seed_homepage_making_slugs.sql`, and `0015_seed_homepage_writing_slugs.sql`, fallback `apps/www/src/data/site.ts`, rendered in `apps/www/src/pages/index.astro` | heading, summary, proof cards, ordered making slugs, ordered writing slugs, press mention, inline links          | D1 controls safe heading, section metadata, proof cards, homepage project ordering, and homepage writing ordering; rich linked summary stays source-backed until inline mention schema exists |
