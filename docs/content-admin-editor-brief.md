...
| stop ending your day with fix the bug | publish now                | existing post with concrete workflow advice                    | fix internal links from `/thoughts` to `/writing` before sending             |
