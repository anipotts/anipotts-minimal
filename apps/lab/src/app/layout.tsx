...
export const metadata: Metadata = {
  title: "lab | ani potts",
  description: "Experiments, demos, and archived projects",
  openGraph: { title: "lab | ani potts", description: "Experiments and demos", url: "https://lab.anipotts.com", siteName: "lab.anipotts.com", type: "website" },
};
            ...
            <WindowLayoutWrapper>
              <WindowContainer>
                <div className="flex items-center justify-between px-4 py-2 bg-white/5 border-b border-white/5 select-none">
                  <div className="flex items-center gap-2"><WindowControls /><TerminalHeaderTitle defaultTitle="ani@potts:~/lab.anipotts.com" /></div>
