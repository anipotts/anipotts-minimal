...
export const metadata: Metadata = {
  ...
  description: "Architecture reference for the anipotts.com ecosystem",
  openGraph: {
    title: "docs | ani potts",
    description: "Architecture reference for the anipotts.com ecosystem",
    url: "https://docs.anipotts.com",
    siteName: "docs.anipotts.com",
    type: "website",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://docs.anipotts.com",
  },
};
...
{`anipotts.com/
├── apps/
│   └── www/                    # Single Next.js app
│       ├── src/
│       │   ├── app/
│       │   │   ├── (main)/     # anipotts.com routes
│       │   │   │   ├── page.tsx
│       │   │   │   ├── work/
│       │   │   │   └── connect/
...
│       │   │   │   └── ...
│       │   │   └── api/
│       │   └── middleware.ts   # Subdomain → route mapping
├── packages/
