...
export const metadata: Metadata = {
  title: "lab | ani potts",
  description: "Experiments, side projects, and open-source work from ani potts",
  openGraph: {
    title: "lab | ani potts",
    description: "Experiments, side projects, and open-source work from ani potts",
    url: "https://lab.anipotts.com",
    siteName: "lab.anipotts.com",
    type: "website",
  },
  twitter: {
  ...
  alternates: {
    canonical: "https://lab.anipotts.com",
  },
};
      ...
      <FadeIn delay={0.4}>
        <div className="p-5 bg-accent-400/5 border border-accent-400/20 rounded-lg">
          ...
          <p className="text-sm text-tertiary mb-3">
            anipotts.com is itself an experiment — a single Next.js app with
            middleware-based subdomain routing. The terminal window UI is a
            custom state machine with four modes: open, collapsed, minimized,
            and fullscreen.
          </p>
