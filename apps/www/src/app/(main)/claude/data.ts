...
export const skills: Skill[] = [
  {
    name: "/review",
    desc: "code review with inline comments",
    href: `${BLOB}/skills/review.md`,
  },
  {
    name: "/refactor",
    desc: "safe refactoring with test coverage",
    href: `${BLOB}/skills/refactor.md`,
  },
  {
    name: "/explain",
    desc: "deep explanation of any codebase",
    href: `${BLOB}/skills/explain.md`,
  },
  {
    name: "/test",
    desc: "generate tests for uncovered code",
    href: `${BLOB}/skills/test.md`,
  },
  {
    name: "/debug",
    desc: "systematic debugging workflow",
    href: `${BLOB}/skills/debug.md`,
  },
  {
    name: "/deploy",
    desc: "deployment checklist and execution",
    href: `${BLOB}/skills/deploy.md`,
  },
  {
    name: "/migrate",
    desc: "dependency and framework migrations",
    href: `${BLOB}/skills/migrate.md`,
  },
  {
    name: "/perf",
    desc: "performance profiling and optimization",
    href: `${BLOB}/skills/perf.md`,
  },
];
...
export const agents: Agent[] = [
  {
    name: "architect",
    desc: "system design and project scaffolding",
    href: `${BLOB}/agents/architect.md`,
  },
  {
    name: "reviewer",
    desc: "thorough code review with context",
    href: `${BLOB}/agents/reviewer.md`,
  },
  {
    name: "debugger",
    desc: "root cause analysis and fix suggestion",
    href: `${BLOB}/agents/debugger.md`,
  },
  {
    name: "writer",
    desc: "documentation and readme generation",
    href: `${BLOB}/agents/writer.md`,
  },
  {
    name: "tester",
    desc: "test generation and coverage analysis",
    href: `${BLOB}/agents/tester.md`,
  },
  {
    name: "optimizer",
    desc: "performance and bundle optimization",
    href: `${BLOB}/agents/optimizer.md`,
  },
  {
    name: "migrator",
    desc: "framework and dependency upgrades",
    href: `${BLOB}/agents/migrator.md`,
  },
  {
    name: "security",
    desc: "vulnerability scanning and hardening",
    href: `${BLOB}/agents/security.md`,
  },
];
