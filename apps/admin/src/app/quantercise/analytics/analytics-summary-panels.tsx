...
export function OverviewPanel({ data }: { data: QCAnalytics }) {
  return (
...
export function ActiveUsersPanel({ data }: { data: QCAnalytics }) {
...
export function SubscriptionPanel({ data }: { data: QCAnalytics }) {
...
export function SubmissionsPanel({ data }: { data: QCAnalytics }) {
