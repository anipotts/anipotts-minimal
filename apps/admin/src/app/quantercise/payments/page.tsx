...
function RevenuePanel({ data }: { data: QCRevenueAnalytics }) {
...
function SubscribersPanel({ data }: { data: QCRevenueAnalytics }) {
  return (
...
function MRRChart({ data }: { data: QCRevenueAnalytics }) {
...
function FailedPaymentsPanel({ data }: { data: QCPaymentAnalytics }) {
...
function DisputesPanel({ data }: { data: QCPaymentAnalytics }) {
...
function DunningPanel({ data }: { data: QCPaymentAnalytics }) {
