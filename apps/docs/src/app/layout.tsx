...
export const metadata: Metadata = {
  ...
  description: "API documentation and system design references",
  openGraph: { title: "docs | ani potts", description: "API documentation", url: "https://docs.anipotts.com", siteName: "docs.anipotts.com", type: "website" },
};
            ...
            <WindowLayoutWrapper>
              <WindowContainer>
                <div className="flex items-center justify-between px-4 py-2 bg-white/5 border-b border-white/5 select-none">
                  <div className="flex items-center gap-2"><WindowControls /><TerminalHeaderTitle defaultTitle="ani@potts:~/docs.anipotts.com" /></div>
