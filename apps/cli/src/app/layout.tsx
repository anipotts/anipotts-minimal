...
export const metadata: Metadata = {
  ...
  openGraph: { title: "cli | ani potts", description: "CLI tools", url: "https://cli.anipotts.com", siteName: "cli.anipotts.com", type: "website" },
};
            ...
            <WindowLayoutWrapper>
              <WindowContainer>
                <div className="flex items-center justify-between px-4 py-2 bg-input border-b border-border-subtle select-none">
                  <div className="flex items-center gap-2"><WindowControls /><TerminalHeaderTitle defaultTitle="ani@potts:~/cli.anipotts.com" /></div>
