...
export function TerminalHeader({
  ...
  return (
    <div className="terminal-header flex items-center justify-between px-6 md:px-10 py-2 bg-input md:bg-transparent border-b border-border-subtle select-none">
