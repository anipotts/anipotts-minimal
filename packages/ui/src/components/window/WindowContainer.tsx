  ...
  return (
    <>
      ...
      <AnimatePresence>
        {windowState === "collapsed" && (
          <motion.div
            ...
            className="fixed inset-0 z-30 bg-[var(--backdrop-dim)] backdrop-blur-sm pointer-events-none"
          />
        )}
      </AnimatePresence>
      ...
      <motion.div
        ...
        animate={windowState}
        className={clsx(
          "bg-card border border-border shadow-2xl flex flex-col relative overflow-hidden ring-1 ring-ring transition-[border-radius,border-width,box-shadow,max-width] duration-[240ms] ease-[cubic-bezier(0.16,1,0.3,1)]",
