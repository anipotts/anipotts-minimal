...
export const PUBLIC_CONTENT_SOURCE_HASH =
  "084cccf3ea2f3e6e5b91816624eb7bd4f7b9ef2217e1f067b82423afe8a8edd0";
...
export const DEFAULT_WRITING_INDEX_CONTENT: ListingPageContent = {
  ...
  hero_title: "writing",
  hero_summary:
    "what i'm learning as i build, and thoughts on the things that hold my attention",
};
...
export const DEFAULT_SYSTEMS_CONTENT: SystemsPageContent = {
  ...
  map_nodes: [
    {
      ...
      detail:
        "services, devices, and real-world inputs produce changes worth noticing.",
      items: [],
    },
    {
      id: "snap_store",
      ...
      detail:
        "facts stay in the service or local record that owns them rather than inside the model.",
      items: [
        "provider events",
        "scheduled scans",
        "local reads",
    ...
    },
    {
      ...
      detail:
        "blockers, approvals, verified changes, and provenance in one private view.",
      items: [],
    },
    {
      id: "ani",
      ...
      title: "ani potts",
      detail:
        "i set direction, grant authority, resolve ambiguity, and own final decisions.",
      items: [],
    },
    {
      id: "agents",
      ...
      detail:
        "workers execute bounded tasks and return consequential or uncertain work to me.",
    ...
    },
    {
      ...
      title: "bounded task",
      detail:
        "execution stays inside task, context, device, and action limits.",
      items: [],
    },
    {
      id: "record",
      ...
      detail:
        "deterministic checks attach evidence before changes return to the record that owns the state.",
      items: [],
    },
    {
      id: "calendar",
    ...
    },
    {
      ...
      title: "1Password",
      detail:
        "credential access enables an authorized action but does not grant authority.",
      items: [],
    },
    {
      id: "infrastructure",
      ...
      title: "Tailnet",
      detail:
        "a private network connects the iPhone, MacBook, and always-on Mac mini runtime.",
      items: [],
    },
  ],
  ...
  map_relationships: [
    {
      ...
      kind: "signal",
      detail:
        "events, local reads, and manual observation enter the record that owns the fact.",
    },
    {
      id: "records_to_ani",
      source: "snap_store",
    ...
    },
    {
      ...
      kind: "needs_human",
      detail:
        "ambiguity, changed goals, and consequential actions return to me.",
    },
    {
      ...
      kind: "credential",
      detail:
        "authorized work can request credentials without exposing their values to the model.",
    },
    {
      ...
      kind: "transport",
      detail:
        "agents reach the appropriate device through the private network.",
    },
    {
      id: "agents_to_record",
      source: "agents",
    ...
    },
    {
      ...
      kind: "verified_update",
      detail:
        "verified changes return to the authoritative record and become context for the next decision.",
    },
  ],
  ...
  principles: [
    {
      ...
      detail:
        "changes across calendars, projects, saved posts and articles, videos and watch history, and everyday life become visible before they disappear.",
    },
    {
      label: "watch",
      title: "keep an eye on what moves",
      detail:
        "agents can follow schedules, deadlines, project state, or patterns and surface the parts worth my attention.",
    },
    {
      label: "prepare",
      title: "make the next decision easier",
      detail:
        "agents gather context, compare options, and prepare work so i can decide from a clear starting point.",
    },
    {
      label: "act",
      title: "carry clear work forward",
      detail:
        "trusted work that is easy to undo can continue on its own. choices that affect other people, money, privacy, or commitments come back to me.",
    },
    {
      label: "check",
      title: "keep the verified result",
      detail:
        "completed work returns with what changed, what was checked, and anything still waiting on me.",
    },
  ],
  ...
  featured_writing: {
    ...
    detail:
      "why i keep the system centered on awareness, ownership, and knowing when my attention matters.",
  },
  ...
  public_tools: [
    {
      ...
      detail:
        "patterns i keep after seeing how agents behave in real repositories.",
    },
    {
      title: "imessage mcp",
      href: "/work/imessage-mcp",
