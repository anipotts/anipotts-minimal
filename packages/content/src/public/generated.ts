...
export const DEFAULT_SYSTEMS_CONTENT: SystemsPageContent = {
  title: "systems",
  description:
    "a personal map for noticing what matters, organizing context, and deciding what agents can watch, prepare, or act on with me.",
  hero_title: "systems",
  hero_summary:
    "i keep a map of the work, people, plans, ideas, and responsibilities moving through my life. it helps me see what matters, decide what needs me, and let agents help with the rest.",
  map_label: "how it moves",
  map_principle:
    "this map shows what agents can notice, watch, prepare, act on, check, and record, and where they work on their own, with me, or through a mix of both.",
  map_domains: [
    {
      label: "career",
      children: ["projects", "applications", "content"],
    },
    {
      label: "learning",
      children: ["school", "research", "skills"],
    },
    {
      label: "wellbeing",
      children: ["health", "routines", "energy"],
    },
    {
      label: "personal",
      children: ["plans + trips", "family + friends", "people i know online"],
    },
  ],
  map_nodes: [
    {
      ...
      detail:
        "career, learning, wellbeing, and personal life keep giving me things to notice.",
      items: [],
    },
    {
      id: "snap_store",
      ...
      detail:
        "thoughts, plans, and things i save get a place to land before they disappear.",
      items: [
        "journal",
        "notes + reminders",
    ...
    },
    {
      ...
      detail:
        "one view of what changed, what needs me, and what can keep moving.",
      items: ["gated by cloudflare access"],
    },
    {
      id: "ani",
  ...
  map_relationships: [
    {
      ...
      authority: "mixed",
      detail:
        "things worth keeping get captured while i can still add the meaning behind them.",
    },
    {
      id: "snap_to_admin",
      source: "snap_store",
    ...
    },
    {
      ...
      authority: "with_me",
      detail:
        "choices, permissions, consequences, and unclear results come back to me.",
    },
    {
      id: "ani_to_agents",
      source: "ani",
    ...
    },
    {
      ...
      authority: "with_me",
      detail:
        "anything still waiting on me returns with the context to decide.",
    },
  ],
