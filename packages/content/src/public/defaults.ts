  ...
  sections: {
    intro: {
      ...
      rich_summary: [
        ...
        {
          segments: [
            { kind: "mention", key: "businessInsider" },
            {
              kind: "text",
...
export const DEFAULT_CMS_PROJECTS: CmsProjectContent[] = [
  {
    ...
    body: "i built quantercise from my own interview-prep workflow. it now combines 400+ quant problems, instant grading, a browser-based python editor, math rendering, progress tracking, and payments in one focused practice loop.",
