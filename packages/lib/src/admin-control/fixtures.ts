...
export const fixtureProjectStates: AdminProjectState[] = [
  ...
  },
  {
    ...
    dedupe_key: "project:job-search",
    project_key: "job-search",
...
export const fixtureTaskStates: AdminTaskState[] = [
  ...
  },
  {
    ...
    current_summary:
      "ordered cleanup workstream is visible in Fleet; root-level reconciliation stays metadata-only until exact proof and approval.",
    final_summary: null,
    next_action:
...
export const fixtureCapabilityStates: AdminCapabilityState[] = [
  {
    ...
    machine: "ap-pro",
    status: "planned",
    auth_model: "hashed-bearer-token-scoped-per-machine",
    write_enabled: false,
...
export const fixtureCareerSnapshots: AdminCareerSnapshot[] = [
  {
    snapshot_id: "career-snapshot-2026-07-16",
    project_ref: "project-job-search",
    ...
    source_status: [
      {
        ...
        summary: "current operating brief and task lineage observed",
      },
      {
        source: "/Users/anipotts/Personal/jobs",
        status: "fresh",
        observed_at: "2026-07-16T12:00:00.000Z",
        summary: "main at 1246caf; product-role focus confirmed",
      },
      {
        source: "gmail and calendar",
        status: "unavailable",
        observed_at: null,
        summary: "manual refresh not run",
      },
      {
        source: "tracker",
        status: "unavailable",
    ...
    current_focus: "funded NYC product, frontend, and full-stack roles",
    readiness: "not assessed",
    next_action:
      "refresh job sources, then choose the next serious application or follow-up",
    contradictions: [],
    commitments: ["Kalshi Product", "Kalshi Frontend", "Polymarket US"],
    proof_refs: [
      "git:anipotts/jobs@1246caf61dff29100dd443a9727b104bbf7dd45a",
      "thread:019f6651-6567-7821-a4a4-b1623b868ddc",
    ],
    updated_at: "2026-07-16T12:00:00.000Z",
  },
];

export const fixtureCareerTargets: AdminCareerTarget[] = [
  {
    target_id: "career-target-kalshi-product",
    snapshot_ref: "career-snapshot-2026-07-16",
    company: "Kalshi",
    role: "Product",
    stage: "research",
    status: "active",
    ...
    interview_at: null,
    next_action: "verify the current role and choose whether to apply",
    source_refs: ["jobs:recommended-apps"],
    source_link_refs: [],
    updated_at: "2026-07-16T12:00:00.000Z",
  },
  {
    target_id: "career-target-kalshi-frontend",
    snapshot_ref: "career-snapshot-2026-07-16",
    company: "Kalshi",
    role: "Frontend",
    stage: "research",
  ...
  {
    target_id: "career-target-polymarket-us",
    snapshot_ref: "career-snapshot-2026-07-16",
    ...
    last_contact_at: null,
    interview_at: null,
    next_action: "confirm role fit and current opening",
    source_refs: ["jobs:recommended-apps"],
    source_link_refs: [],
    updated_at: "2026-07-16T12:00:00.000Z",
  },
...
export const fixtureProjections: AdminControlProjections = {
  ...
  career_snapshots: fixtureCareerSnapshots,
  career_targets: fixtureCareerTargets,
