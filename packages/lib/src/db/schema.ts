...
export const adminProjectStates = sqliteTable(
  "admin_project_states",
  {
    ...
    entity_ref: text("entity_ref"),
    owner_chief: text("owner_chief").notNull(),
    repository: text("repository"),
    canonical_remote: text("canonical_remote"),
    pro_path: text("pro_path"),
    mini_path: text("mini_path"),
    canonical_host_role: text("canonical_host_role").notNull(),
  ...
  (table) => [
    ...
    index("idx_admin_project_owner").on(table.owner_chief),
  ],
);
...
export const adminTaskStates = sqliteTable(
  "admin_task_states",
  {
    ...
    current_summary: text("current_summary").notNull(),
...
export const adminTaskLineage = sqliteTable(
  ...
  (table) => [
    ...
    index("idx_admin_task_lineage_group").on(table.lineage_group_id),
  ],
);
